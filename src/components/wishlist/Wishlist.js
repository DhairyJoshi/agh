...
import { user_wishlist_list } from '../../redux/actions/ProductAction'
...
export default function Wishlist() {
    ...
    const all_products = useSelector((state) => state?.products?.all_wishlist)
    ...
    return (
        <div>
            ...
            <Breadcrumbs main={"Wishlist"} parent={"Wishlist"} />
                                    ...
                                    !all_products?.data?.length ?
                                        <div className='container py-20'>
                                            <Grid container spacing={2} sx={{ display: "flex", justifyContent: "center" }}>
                                                <Grid size={6}>
                                                    <Alert severity="warning" style={{ borderRadius: "10px", fontSize: "17px" }} className='p-20'>You have not added any products yet !</Alert>
                                                </Grid>
                                            </Grid>
                                        </div>
                                        :
